...
WASM="$ROOT_DIR/target/wasm32-unknown-unknown/release/holder_near_subkeys.wasm"
REEMIT_WASM="$ROOT_DIR/target/wasm32-unknown-unknown/release/holder_near_subkeys.reemit.wasm"
MVP_WASM="$ROOT_DIR/target/wasm32-unknown-unknown/release/holder_near_subkeys.mvp.wasm"
...
wasm2wat "$WASM" -o "$ROOT_DIR/target/wasm32-unknown-unknown/release/holder_near_subkeys.wat"
wat2wasm "$ROOT_DIR/target/wasm32-unknown-unknown/release/holder_near_subkeys.wat" -o "$REEMIT_WASM"
